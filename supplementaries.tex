...
\caption{Memory leaks in megabytes incurred by different PyRanges functionality} % add dummy caption - otherwise \label won't work and figure numbering will not count up
